...
== Screenshots ==
1. GS Logo Slider with Default Color.
2. Default to Gray color in Reverse Direction.
3. GS Logo in Ticker Mode like News Scroll in both Direction.
4. Vertical Ticker Up.
5. 2 Rows Slider & Default Color.
6. Display Logos Vertically.
7. Logos Filter - 1 & Default Color.
8. Logos Live Filter.
9. GIF Logos supported in Slider.
10. Custom Order for GS Logo Slider. After Drag & Drop, go to Logo Shortcode > Crete/Edit Shortcode > Go to Query (3rd tab) > Set Order: ASC (From Dropdown). ASC/DESC may be set to your liking. > Set Order By: Custom Order (From Dropdown)
11. Add a new Logo.
12. All Logos.
13. Created Shortcodes list for Logo.
14. Create New Shortcode For Logo Slider with Preview.
15. Preferences / Custom CSS & Skip Lazy Loading for logos in Logo Slider.
16. Install Demo Data for Logo Slider plugin.
17. GS Logo Slider General Settings.
18. GS Logo Style Settings(2nd Tab).
19. GS Logo Slider Query Settings (3rd Tab).
20. Logo Gutenberg Block.
21. Logo Widget for Elementor.
22. WPBakery - Logo Slider Element.
23. Divi Builder - GS Logo Slider Module.
